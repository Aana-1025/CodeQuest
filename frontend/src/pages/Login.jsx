  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!accessToken || !refreshToken) {
        setError("Login response was missing tokens.");
        return;
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-slate-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-6 sm:p-8">
        <h1 className="text-2xl font-semibold text-slate-900 mb-4">Welcome back</h1>
        <p className="text-sm text-slate-600 mb-6">Sign in to continue your CodeQuest learning path.</p>
